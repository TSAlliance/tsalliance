export default {
    ...
    ACCOUNT_NAME_EXISTS: { errorId: "ACCOUNT_NAME_EXISTS", statusCode: 400, message: "Ein Konto mit diesem Name existiert bereits" },

    INVALID_INVITE: { errorId: "INVALID_INVITE", statusCode: 400, message: "Ungültige Einladung" },
    SEND_MAIL_FAILED: { errorId: "SEND_MAIL_FAILED", statusCode: 400, message: "Die E-Mail konnte nicht gesendet werden" },

    DISCORD_ERROR: { errorId: "DISCORD_ERROR", statusCode: 400, message: "Es ist ein Fehler bei der Kommunikation mit Discord aufgetreten" },
}